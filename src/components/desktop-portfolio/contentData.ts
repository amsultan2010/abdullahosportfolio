...
Thanks for stopping by.`
  ...
  'prestige-is-a-strong-drug': {
    ...
    markdown: `Prestige is one of the strongest psychological drugs a person can take. The dangerous part is that it feels exactly like progress, even when nothing meaningful is happening.

I learned this the hard way.

For a while I was in one of the most competitive programs in Canada. The kind of program people treat like a golden ticket. When you mention it in conversation, people nod differently. They assume you are smart. They assume your future is already sorted out.

For a while I believed it too.

Being surrounded by ambitious people creates a strange environment. Everyone is talented. Everyone is competing. Everyone is optimizing for the next internship, the next offer, the next signal that proves they belong there.

At first it feels electric. It feels like you are standing in the center of momentum.
...
Walking away from that environment forced me to confront something much more difficult.

Without the prestige, there is nothing left to lean on. No reputation to borrow. No label that automatically signals competence.

You are left with a very simple question.

**If nobody is impressed by your situation anymore, what are you actually capable of building?**

Strangely enough, that question turned out to be far more valuable than the prestige itself.

Prestige feels powerful because it tells you that you are already on the right path.

But real growth usually begins the moment that certainty disappears.`
  },
